            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="<?php echo base_url('admin/wisata/create') ?>" type="button" class="btn btn-primary">Tambah</a>
                    </div>
                    <!-- /.panel-heading -->
                                    ...
                                    <?php foreach ($wisata as $key => $value): ?>
                                        <tr>
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="<?php echo base_url('admin/wisataimage/image/'  . $value['BANGUNAN_ID']) ?>" type="button" class="btn btn-primary">Gambar</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
